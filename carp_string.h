...
extern bool _carp_string_setcap(carp_string_t* s, size_t size);
// 设置字符串长度
extern bool _carp_string_setlen(carp_string_t* s, size_t size);
extern const char* _carp_string_str(carp_string_t* s);
extern size_t _carp_string_len(carp_string_t* s);
extern void _carp_string_free(carp_string_t* s);
extern void _carp_string_putsn(carp_string_t* s, const char* p, size_t l);
extern void _carp_string_puts(carp_string_t* s, const char* p);
extern void _carp_string_putc(carp_string_t* s, char c);
extern void _carp_string_assigns(carp_string_t* s, const char* p);
extern void _carp_string_assignsn(carp_string_t* s, const char* p, size_t l);
#define carp_string_npos ((size_t)(-1))
extern size_t _carp_string_findc(carp_string_t* s, char c);
extern size_t _carp_string_finds(carp_string_t* s, const char* p);
...
// 如果容量不足size，就扩展到size，否则不变
extern bool _carp_wstring_setcap(carp_wstring_t* s, size_t size);
// 设置字符串长度
extern bool _carp_wstring_setlen(carp_wstring_t* s, size_t size);
extern const wchar_t* _carp_wstring_str(carp_wstring_t* s);
extern size_t _carp_wstring_len(carp_wstring_t* s);
extern void _carp_wstring_free(carp_wstring_t* s);
extern void _carp_wstring_putsn(carp_wstring_t* s, const wchar_t* p, size_t l);
extern void _carp_wstring_puts(carp_wstring_t* s, const wchar_t* p);
extern void _carp_wstring_putc(carp_wstring_t* s, wchar_t c);
#define _carp_wstring_npos ((size_t)(-1))
extern size_t _carp_wstring_findc(carp_wstring_t* s, wchar_t c);
extern size_t _carp_wstring_finds(carp_wstring_t* s, const wchar_t* p);
extern void _carp_wstring_assigns(carp_wstring_t* s, const wchar_t* p);
extern void _carp_wstring_assignsn(carp_wstring_t* s, const wchar_t* p, size_t l);
